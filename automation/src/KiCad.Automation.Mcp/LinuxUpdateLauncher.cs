...
internal sealed record UpdateLaunchContext(LinuxUpdateHandoffRequest Request, InstalledLinuxUpdate Version,
...
internal static class LinuxUpdateLauncher
{
    public static async Task<UpdateHandoffState> LaunchAsync(UpdateLaunchContext context,
        Func<UpdateHandoffState, CancellationToken, Task> record, CancellationToken token,
